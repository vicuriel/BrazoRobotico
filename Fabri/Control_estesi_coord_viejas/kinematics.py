...
from limits_parameters import l1, l2, l3, l4, a, b, c, d, e
...
def print_ik(x, y, z, phi_deg, q_prev=None, limits=None, codo_estandar=None):
    q = ik(x, y, z, phi_deg, q_prev=q_prev, limits=limits, codo_estandar=codo_estandar)
    if q is None:
        print("IK -> No hay solución válida para la pose dada.")
    else:
        print(f"IK: q1={q[0]:.2f}°, q2={q[1]:.2f}°, q3={q[2]:.2f} cm, q4={q[3]:.2f}°")
